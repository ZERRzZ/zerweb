...
// export const autoLegend = (printmodel: PrintModelParam, position?: Position) => {

//   let style = (printmodel.style as Style).rules[0].rasterRules[0].grades
...
//     let zhArr = v.label.match(/[^\x00-\xff]/g)
//     let zhLen = zhArr ? zhArr.length : 0
//     let enLen = v.label.length - zhLen
